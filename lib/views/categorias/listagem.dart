                      ...
                      return categoriaCtrl.carregandoPesquisa
                          ...
                          : RefreshIndicator(
                              ...
                              child: Container(
                                ...
                                child: Observer(builder: (_) {return  GridView.builder(
                                  ...
                                  itemBuilder: (context,index){
                                    if (index ==
                                              categoriaCtrl.categorias.length) {
                                            if (categoriaCtrl.pagina <
                                                categoriaCtrl.quantidadePaginas)
                                              return Container(
                                                child: Padding(
