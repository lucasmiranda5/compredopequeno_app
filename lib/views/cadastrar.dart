          ...
          Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                TextField(
                  decoration:
                      InputDecoration(labelText: 'Descrição da empresa'),
                  maxLines: 5,
                  onChanged: controller.setDescricao,
                ),
                TextField(
                  decoration:
                      InputDecoration(labelText: 'Hórario de Funcionamento'),
                  maxLines: 2,
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    controller.file == null
                        ...
                        : Image.file(controller.file, width: 100,);
                    }),
                  ],
                ),
                Row(
                  children: <Widget>[
                    Expanded(
                      ...
                      child: DropdownButtonFormField(
                        decoration:
                            InputDecoration(labelText: 'Tipo do contato'),
                        items: [
                          DropdownMenuItem(
                            child: Text('WhatsApp'),
                            value: 'whatsapp',
