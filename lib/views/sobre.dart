            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text(
                      "Nesse momento de pandemia mundial onde pequenos negócios e profissionais liberais vem sendo muito afetados, nós da ACIAPI/CDL, SEBRAE, IFNMG Campus Pirapora e SEDEARE juntamos forças para poder trazer meios de minimizar as perdas nesse momento, uma das nossas ações é nosso aplicativo Comércios em Pirapora que tem como foco divulgar todas as empresas para que as pessoas possam entrar em contato e comprar produtos ou realizar serviços."),
                  Text("Esse serviço é 100% gratuito para todas as empresas de Pirapora. Um projeto Open Source que tem seu código no Github para contribuições."),
                  ...
                  Text("SEDEARE – Secretaria de Desenvolvimento Econômico, Agricultura, Emprego e Renda de Pirapora"),
